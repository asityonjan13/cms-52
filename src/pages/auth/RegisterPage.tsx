                        ...
                        <form className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="date"
                                            id="birthday"
                                            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 text-gray-900"
                                            autoComplete="bday"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <label htmlFor="terms" className="ml-2 text-sm text-gray-700">
                                    I agree to the{' '}
                                    <a href="/terms" className="text-teal-600 hover:text-teal-700 font-semibold">
                                        Terms and Conditions
                                    </a>
                                    {' '}and{' '}
                                    <a href="/privacy" className="text-teal-600 hover:text-teal-700 font-semibold">
                                        Privacy Policy
                                    </a>
                                </label>
                            </div>
